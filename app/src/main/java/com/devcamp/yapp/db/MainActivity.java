...
//        dynamicFrame.setId(DYNAMIC_VIEW_ID + numLayout);
        final FrameLayout dynamicFrame = new FrameLayout(this);
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        FrameLayout finalFrame = (FrameLayout) inflater.inflate(R.layout.preview_home, dynamicFrame);

        finalFrame.getBackground();
        finalFrame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ViewGroup layout = (ViewGroup) findViewById(dynamicFrame.getId());
